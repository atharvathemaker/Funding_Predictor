...
4. [Algorithms & Methodology](#4-algorithms--methodology)
5. [Setup & Execution](#5-setup--execution)
...
**Methodology:**
1. Continuous variables (ARR, Burn Multiple, Pedigree) are binarised at their medians.
2. `mlxtend.apriori` extracts frequent itemsets with `min_support = 0.05`.
3. `association_rules()` filters by `lift ≥ 1.2` — ensuring rules exceed random co-occurrence.
